...
export interface UIStrings {
  ...
  profile: {
    ...
    tabServers: string;
    tabServersDescription: string;
    tabSecurity: string;
    tabSecurityDescription: string;
    avatarSet: string;
    noAvatar: string;
    itemsSuffix: string;
    serversSuffix: string;
    verified: string;
    pending: string;
  ...
  servers: {
    ...
    noPassword: string;
    connectionFieldsLabel: string;
    hostField: string;
    portField: string;
    passwordField: string;
    copyHost: string;
    copyPort: string;
    copyServerPassword: string;
    hostCopied: string;
    portCopied: string;
    serverPasswordCopied: string;
    tagsLabel: string;
    liveState: string;
    serverName: string;
    details: string;
